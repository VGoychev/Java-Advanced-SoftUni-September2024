...
public class _03_IntersectionOfTwoMatrices {
    public static void main(String[] args) {
        ...
        char[][] thirdMatrix = makeThirdMatrix(firstMatrix, secondMatrix, rows, cols);
    ...
    private static char[][] makeThirdMatrix(char[][] firstMatrix, char[][] secondMatrix, int rows, int cols){
        char[][] matrix = new char[rows][cols];
